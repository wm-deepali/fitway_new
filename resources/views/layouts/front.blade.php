...
<body class="theme-brown">
                ...
                <div class="clearfix">
                    ...
                    <div class="pull-left logo-outer">
                        <div class="logo"><a href="{{ route('home') }}"><img
                                    src="{{ $siteLogo?->image_url ?? asset('front/img/logo.png') }}" alt=""
                                    title="Sri Harihar"></a></div>
                    </div>
                        ...
                        <div class="mainmenu-bg clearfix">
                            <div class="main-menu-area clearfix">
                                <nav class="main-menu">
                                    ...
                                    <div class="navbar-collapse collapse clearfix">
                                        <ul class="navigation clearfix">
                                            ...
                                            <li class="{{ request()->routeIs('products') ? 'current' : '' }}"><a
                                                    href="{{ route('products') }}">Products</a></li>
                                            <li class="{{ request()->routeIs('enquiry') ? 'current' : '' }}"><a
                                                    href="{{ route('enquiry') }}">Send Enquiry</a></li>
                                            <li class="{{ request()->routeIs('locate-us') ? 'current' : '' }}"><a
                                                    href="{{ route('locate-us') }}">Contact</a></li>
                                        </ul>
                                    </div>
                                </nav>
                                ...
                                <ul class="actions-outer pull-right clearfix">
                                    <li>
                                        <div class="sidenav-toggler hidden-bar-opener"><a href="#"
                                                class="theme-btn catalogue-btn">MENU</a></div>
                                    </li>
                                </ul>
                ...
                <div class="hidden-bar-wrapper">
                    <div class="logo text-center">
                        <a href="{{ route('home') }}"><img
                                src="{{ $siteLogo?->image_url ?? asset('front/img/logo.png') }}" alt=""></a>
                    </div>
                    <div class="side-menu">
                        <ul class="navigation clearfix">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-resent">
                        ...
                        <div class="resent-1">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1779.3157655496882!2d80.93061195078947!3d26.883445495670173!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399bfd81307fcfdf%3A0x8837ca9dec7ba2fc!2sSri+Harihar+Ply+%26+Hardware!5e0!3m2!1sen!2sin!4v1512115957510"
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="footer-about">
                        ...
                        <h6><img src="https://cdn0.iconfinder.com/data/icons/social-flat-rounded-rects/512/whatsapp-256.png"
                                class="whatsapp"> +91-902-618-7442</h6>
    ...
    <script type="text/javascript"
        src="{{ asset('front/revolution/js/extensions/revolution.extension.actions.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('front/revolution/js/extensions/revolution.extension.carousel.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('front/revolution/js/extensions/revolution.extension.kenburn.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('front/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('front/revolution/js/extensions/revolution.extension.migration.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('front/revolution/js/extensions/revolution.extension.navigation.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('front/revolution/js/extensions/revolution.extension.parallax.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('front/revolution/js/extensions/revolution.extension.slideanims.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('front/revolution/js/extensions/revolution.extension.video.min.js') }}"></script>
