        ...
        <div class="colC">
          <ul class="menu-list">
            ...
            <li class="cart-wrapper">
              <a href="{{ route('cart.index') }}" class="cart-btn" aria-label="View Cart">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M3 4h2l2.2 10.2a2 2 0 0 0 2 1.6h7.9a2 2 0 0 0 1.9-1.4L21 7H6L5 4H3Z" />
      ...
      <div class="footer-middle">
        <div class="container">
          ...
          <div class="colC">
            ...
            <ul class="blog-list">
              <li>
                <img src="{{ asset('assets/images/home/blog3.jpg') }}"
                  alt="7 Best shoulder exercises you're not doing" />
                <div class="content">
                  <a href="javascript:void(0)">How to Start Commercial Gym in India</a>
                  <span>August 07, 2026</span>
                </div>
              </li>
              <li>
                <img src="{{ asset('assets/images/home/blog1.jpg') }}"
                  alt="8 Things You Should Never Do On Chest Day" />
                <div class="content">
                  <a href="javascript:void(0)">5 Popular Machines required for Home Gym</a>
                  <span>August 12, 2026</span>
                </div>
              </li>
              <li>
                <img src="{{ asset('assets/images/home/blog2.jpg') }}" alt="Louis Williams Instinctive Back Workout" />
                <div class="content">
                  <a href="javascript:void(0)">How to Setup Outdoor Gym in Your Lawn</a>
              ...
              <li>
                <img src="{{ asset('assets/images/home/blog1.jpg') }}"
                  alt="8 Things You Should Never Do On Chest Day" />
                <div class="content">
                  <a href="javascript:void(0)">Best Gym Excercise to do at Home</a>
          ...
          <div class="colD">
            ...
            <form class="form" method="POST" action="#">
              ...
              <div class="form-group">
                ...
                <label for="txtNewsletterEmail">Enter your email address</label>
              </div>
              <button type="submit" class="sbmt btn btn-white">
                Subscribe
                <svg viewBox="0 0 24 24" fill="none" width="16" height="16">
                  <path d="M5 12h14m0 0-6-6m6 6-6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
  ...
  <div class="ham-pop">
    <button class="close close-btn">
      <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0.5 0.5L25.5 25.5M0.5 25.5L25.5 0.5" stroke="black" stroke-linecap="round" stroke-linejoin="round">
        </path>
      </svg>
    </button>
    ...
    <div class="model-body">
      ...
      <form class="form form-grid" method="POST" action="{{ route('setup-gym.store') }}" id="setupGymForm">
        ...
        <div class="requirement-group">
          <span class="requirement-group__title">Select Your Requirements</span>

          <div class="requirement-list">
            <label class="requirement-item">
              <input type="checkbox" name="requirements[]" value="Gym Equipment" />
              <span class="requirement-item__box"></span>
              <span class="requirement-item__label">Gym Equipment</span>
            </label>

            <label class="requirement-item">
              <input type="checkbox" name="requirements[]" value="Interior Setup" />
              <span class="requirement-item__box"></span>
            ...
            <label class="requirement-item">
              <input type="checkbox" name="requirements[]" value="Maintenance Services" />
              <span class="requirement-item__box"></span>
              <span class="requirement-item__label">Maintenance Services</span>
            </label>
          </div>
        </div>
