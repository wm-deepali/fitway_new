    ...
    <div class="container">
      <div class="grid">
        <div class="secB-media">
          <img src="{{ asset('assets/images/home/about-sec.jpg') }}" alt="Fitway commercial gym setup" />
        </div>
    ...
    <div class="container">
      ...
      <ul class="tab-nav">
        @foreach ($productCategories as $category)
          <li class="{{ $loop->first ? 'active' : '' }}" data-tab="{{ $category->slug }}">
      ...
      <div class="tab-nav-content">
        @foreach ($productCategories as $category)
          ...
          @endphp
          <div class="tabs {{ $loop->first ? 'active' : '' }}" data-tab="{{ $category->slug }}">
              ...
              <div class="swiper catSlider">
                <div class="swiper-wrapper">
                  @forelse ($subCategories as $subCategory)
                    <div class="swiper-slide">
                      <div class="prod-card">
                        <a href="{{ route('products.subcategory', [$category->slug, $subCategory->slug]) }}" class="img">
                  ...
                  @empty
                   <div class="swiper-slide">
                      <div class="prod-card no-prod">
                        ...
                        <div class="content">
                          <h5>Find Your Equipment</h5>
                          <p>Discover our complete range of premium gym and fitness equipment.</p>
                          <a href="{{ route('products') }}" class="btn btn-primary">Explore Our Products</a>
                        </div>
                      </div>
                    </div>
                  @endforelse
    ...
    <div class="grid-wrapper">
      <div class="programSlider swiper">
        <div class="swiper-wrapper">
          @foreach ($productCategories as $category)
            <div class="swiper-slide">
              <img src="{{ $category->banner_url }}" alt="{{ $category->category_name }}" />
            </div>
          @endforeach
        </div>
      </div>
      ...
      <ul class="grid">
        @foreach ($productCategories as $category)
          <li class="item {{ $loop->first ? 'active' : '' }}">
            ...
            <div class="content">
              <svg class="plate-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 9v6M20 9v6M7 7v10M17 7v10M7 12h10" stroke="currentColor" stroke-width="1.6"
        ...
        <ul class="secD-steps">
          <li class="step" data-step="1">
            <div class="step-media">
              <img src="{{ asset('assets/images/home/planing.jpg') }}" alt="Space Planning" />
          ...
          <li class="step" data-step="2">
            <div class="step-media">
              <img src="{{ asset('assets/images/home/GymDesign.avif') }}" alt="Gym Design" />
          ...
          <li class="step" data-step="4">
            <div class="step-media">
              <img src="{{ asset('assets/images/home/Interiors.avif') }}" alt="Interiors" />
          ...
          <li class="step" data-step="5">
            <div class="step-media">
              <img src="{{ asset('assets/images/home/install.jpg') }}" alt="Installation" />
          ...
          <li class="step" data-step="6">
            <div class="step-media">
              <img src="{{ asset('assets/images/home/Ready-Operate.avif') }}" alt="Ready to Operate" />
    ...
    <div class="container">
      ...
      <div class="points-list">
        <div class="point">
          ...
          <div class="point-img">
            <img src="{{ asset('assets/images/home/Quality-Equipment.jpg') }}" alt="Quality Equipment" />
          </div>
        </div>
        ...
        <div class="point">
          ...
          <div class="point-img">
            <img src="{{ asset('assets/images/home/exctuion.avif') }}" alt="Complete Execution" />
          </div>
        </div>
        ...
        <div class="point">
          ...
          <div class="point-img">
            <img src="{{ asset('assets/images/home/Expert-Guidance.jpg') }}" alt="Expert Guidance" />
          </div>
        </div>
        ...
        <div class="point">
          ...
          <div class="point-img">
            <img src="{{ asset('assets/images/home/end-to-end.avif') }}" alt="End-to-End Support" />
          </div>
        </div>
      </div>
