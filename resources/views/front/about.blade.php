...
@section('title', $pageSeo->seo->meta_title ?? 'About Us | Fitway')
@section('meta_description', $pageSeo->seo->meta_description ?? 'Fitway offers professional gym equipment and complete commercial gym setup solutions across India. Learn about our vision, mission and the people behind Fitway.')
        ...
        <div class="bg">
            ...
            <div class="container">
                <div class="banner-wrapper">
                    <div class="content">
                        <h1>{{ $pageSeo->seo->h1 ?? 'Built for Better Fitness.' }}</h1>
        ...
        <div class="container">
            <div class="about-intro__grid">
                <div class="about-intro__img">
                    ...
                    <img src="{{ asset('assets/images/home/about-sec.jpg') }}" alt="Fitway Gym Space" />
            ...
            <div class="about-services__grid">
                <div class="about-services__card">
                    <div class="about-services__img">
                        <img src="{{ asset('assets/images/home/commercil-gym.jpg') }}" alt="Premium Gym Equipment" />
                ...
                <div class="about-services__card">
                    <div class="about-services__img">
                        <img src="{{ asset('assets/images/home/Complete.jpg') }}" alt="Complete Gym Setup" />
        ...
        <div class="container">
            ...
            <div class="about-vm__grid">
                    ...
                    <span class="about-vm__icon">
                        <svg viewBox="0 0 24 24">
                            <path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7-11-7-11-7z" stroke="currentColor" fill="none"
                                stroke-width="1.8" />
                            <circle cx="12" cy="12" r="3" stroke="currentColor" fill="none" stroke-width="1.8" />
                        </svg>
                    </span>
                ...
                <div class="about-vm__card about-vm__card--primary">
                    <span class="about-vm__icon">
                        <svg viewBox="0 0 24 24">
                            <path d="M13 2L3 14h7l-1 8 11-14h-7l1-8z" stroke="currentColor" fill="none" stroke-width="1.8"
        ...
        <div class="container">
            <div class="about-founder__grid">
                <div class="about-founder__img">
                    <img src="{{ asset('assets/images/home/founder.png') }}" alt="Founder, Fitway" />
