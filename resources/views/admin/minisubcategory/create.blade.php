{{-- resources/views/admin/minisubcategory/create.blade.php --}}
...
<div class="main-section">
    ...
    <div class="app-content content container-fluid">
        <div class="cat-page">
            ...
            <div class="cat-card">
                <form action="{{ route('admin.minisubcategories.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            value="{{ old('name') }}" placeholder="Enter mini sub category name" required>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-primary-dash">
                            <i class="fa fa-check"></i> Save Mini Sub Category
                        </button>
                        <a href="{{ route('admin.minisubcategories.index') }}" class="btn-secondary-dash">Cancel</a>
                    </div>
