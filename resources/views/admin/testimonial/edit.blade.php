...
<div class="main-section">
    ...
    .current-img-preview { width: 90px; height: 90px; border-radius: 50%; object-fit: cover; border: 1px solid var(--border); margin-bottom: 10px; display: block; }
    </style>
    ...
    <div class="app-content content container-fluid">
        <div class="cat-page">
            ...
            <div class="cat-page-header">
                ...
                <a href="{{ request('redirect', route('admin.testimonials.index')) }}" class="btn-secondary-dash">
            ...
            <div class="cat-card">
                <form action="{{ route('admin.testimonials.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="company" name="company" class="form-control-styled"
                    ...
                    <div class="form-field">
                        ...
                        @if($testimonial->image)
                            <img src="{{ asset('storage/' . $testimonial->image) }}" class="current-img-preview" alt="{{ $testimonial->name }}">
                        @endif
                    ...
                    <div class="form-field">
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="form-control-styled @error('description') is-invalid @enderror" required>{{ old('description', $testimonial->description) }}</textarea>
                        @error('description') <div class="form-error">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-field">
                        <label for="sort_order">Sort Order</label>
                        <input type="number" id="sort_order" name="sort_order" class="form-control-styled"
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-primary-dash">
                            <i class="fa fa-check"></i> Update Testimonial
                        </button>
                        <a href="{{ request('redirect', route('admin.testimonials.index')) }}" class="btn-secondary-dash">Cancel</a>
                    </div>
