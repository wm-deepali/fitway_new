            ...
            <div class="cat-card">
                ...
                <div class="cat-table-wrap">
                    ...
                    @php
                        ...
                        function subcatSortIcon($column) {
                    ...
                    <table class="cat-table">
                        <thead>
                            <tr>
                                <th>
                                    <a href="{{ subcatSortUrl('id') }}" class="sort-link">
                                        ID {!! subcatSortIcon('id') !!}
                                    </a>
                                </th>
                                <th>Image</th>
                                <th>
                                    <a href="{{ subcatSortUrl('name') }}" class="sort-link">
                                        Name {!! subcatSortIcon('name') !!}
                                    </a>
                                </th>
                                <th>Parent</th>
                                <th>
                                    <a href="{{ subcatSortUrl('status') }}" class="sort-link">
                                        Status {!! subcatSortIcon('status') !!}
                                    </a>
                                </th>
                        ...
                        <tbody>
                            @forelse($subCategories as $sub)
                                <tr id="row{{ $sub->id }}">
                                    ...
                                    <td><span class="id-chip">{{ $sub->id }}</span></td>

                                    <td>
                                        @if($sub->image)
                                            <img src="{{ asset('storage/' . $sub->image) }}"
                                                class="cat-img" alt="{{ $sub->name }}">
                                        @else
                                    ...
                                    <td>
                                        <div class="cat-name-cell">
                                            ...
                                            <small>{{ $sub->unique_products_count }} products</small>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="6">
                                        <div class="empty-state">
                                            ...
                                            <strong style="font-size:14px;color:var(--text-primary)">No sub categories found</strong>
                                            <p>Try adjusting your filters or add a new sub category to get started.</p>
                                            <a href="{{ route('admin.subcategories.create') }}" class="btn-primary-dash">
                                                <i class="fa fa-plus"></i> Add Sub Category
                                            </a>
                                        </div>
