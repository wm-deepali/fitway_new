{{-- resources/views/admin/subsubcategory/create.blade.php --}}
    ...
    <div class="app-content content container-fluid">
        <div class="cat-page">
            ...
            <div class="cat-page-header">
                ...
                <a href="{{ route('admin.subsubcategories.index') }}" class="btn-secondary-dash">
                ...
                <form action="{{ route('admin.subsubcategories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-field">
                        ...
                        <select id="sub_cat_id" name="sub_cat_id"
                            class="form-control-styled @error('sub_cat_id') is-invalid @enderror" required disabled>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            value="{{ old('name') }}" placeholder="Enter sub sub category name" required>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="slug" name="slug" class="form-control-styled" readonly
                            value="{{ old('slug') }}" placeholder="Auto-generated from sub sub category name">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="h1" name="h1"
                            ...
                            value="{{ old('h1') }}" placeholder="Auto-filled from Sub Sub Category Name">
                    ...
                    <div class="form-field">
                        ...
                        <div class="hint">Leave blank to automatically use the Sub Sub Category Image as OG Image</div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-primary-dash">
                            <i class="fa fa-check"></i> Save Sub Sub Category
                        </button>
                        <a href="{{ route('admin.subsubcategories.index') }}" class="btn-secondary-dash">Cancel</a>
                    </div>
