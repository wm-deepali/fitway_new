            ...
            <div class="cat-card">
                ...
                <div class="cat-table-wrap">
                    ...
                    <table class="cat-table">
                        ...
                        <tbody>
                            @forelse($subSubCategories as $sub)
                                <tr id="row{{ $sub->id }}">
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="empty-state">
                                            ...
                                            <strong style="font-size:14px;color:var(--text-primary)">No sub sub categories found</strong>
                                            <p>Try adjusting your filters or add a new sub sub category to get started.</p>
                                            <a href="{{ route('admin.subsubcategories.create') }}" class="btn-primary-dash">
                                                <i class="fa fa-plus"></i> Add Sub Sub Category
                                            </a>
                                        </div>
...
function deleteSubSubCategory(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ url('admin/sub-sub-categories') }}/" + id,
                type: "DELETE",
