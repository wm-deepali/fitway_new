            ...
            <div class="vend-page-header">
                <div>
                    ...
                    <div class="vend-breadcrumb">
                        ...
                        <a href="{{ route('admin.manage-vendors.index') }}">Vendors</a> › Add
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('admin.manage-vendors.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="vendor_name" class="form-control-styled" value="{{ old('vendor_name') }}">
                            @error('vendor_name') <div class="error-text">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group">
                            <label>GST Number</label>
                            <input type="text" name="gst_number" class="form-control-styled" value="{{ old('gst_number') }}">
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <textarea name="full_address" class="form-control-styled">{{ old('full_address') }}</textarea>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control-styled" value="{{ old('email') }}">
                            @error('email') <div class="error-text">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group">
                            <label>Contact Person Name *</label>
                            <input type="text" name="contact_person_name" class="form-control-styled" value="{{ old('contact_person_name') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="mobile_number" class="form-control-styled" value="{{ old('mobile_number') }}">
                            @error('mobile_number') <div class="error-text">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group">
                            <label>WhatsApp Number</label>
                            <input type="text" name="whatsapp_number" class="form-control-styled" value="{{ old('whatsapp_number') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label>Pincode</label>
                            <input type="text" name="pincode" class="form-control-styled" value="{{ old('pincode') }}">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-primary-dash"><i class="fa fa-save"></i> Save Vendor</button>
