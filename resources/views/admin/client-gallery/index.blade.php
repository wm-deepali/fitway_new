    ...
    <div class="app-content content container-fluid">
        <div class="cat-page">
            ...
            <div class="cat-page-header">
                ...
                <a href="{{ route('admin.client-gallery.create') }}" class="btn-primary-dash">
            ...
            <div class="cat-card">
                <table class="cat-table">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row-actions">
                                        <a href="{{ route('admin.client-gallery.edit', $gallery) }}" class="icon-btn" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.client-gallery.destroy', $gallery) }}" method="POST"
                        ...
                        @empty
                            <tr>
                                <td colspan="2" class="empty-state">No gallery entries added yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
