    ...
    <div class="app-content content container-fluid">
        <div class="cat-page">
            ...
            <div class="cat-page-header">
                ...
                <a href="{{ route('admin.instagram.index') }}" class="btn-secondary-dash">
            ...
            <div class="cat-card">
                <form action="{{ route('admin.instagram.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('admin.instagram.index') }}" class="btn-secondary-dash">Cancel</a>
                    </div>
                </form>
            </div>
