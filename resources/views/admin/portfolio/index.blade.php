...
<div class="main-section">
    ...
    .row-desc { max-width: 280px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-secondary); }
...
@endif
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="empty-state">No portfolio items added yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
