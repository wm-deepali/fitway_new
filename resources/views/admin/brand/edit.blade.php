        ...
        <div class="brand-page">
            ...
            <div class="brand-page-header">
                ...
                <div class="brand-breadcrumb">
                    ...
                    <a href="{{ route('admin.brands.index') }}">Brands</a> › Edit
                </div>
            </div>
            ...
            <div class="brand-card">
                <form action="{{ route('admin.brands.update', $brand) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control-styled" value="{{ old('name', $brand->name) }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="logo-preview-wrap">
                            <img id="logoPreview" class="logo-preview" src="{{ $brand->logo_url ?? asset('Admin/images/no-image.svg') }}" alt="">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control-styled">{{ old('description', $brand->description) }}</textarea>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-primary-dash"><i class="fa fa-save"></i> Update Brand</button>
