...
<div class="main-section">
    ...
    .form-row-cols { display: flex; gap: 16px; }
    .form-row-cols .form-group { flex: 1; }
    ...
    @media (max-width: 768px) {
        ...
        .form-row-cols { flex-direction: column; gap: 0; }
    }
    </style>
    ...
    <div class="app-content content container-fluid">
        <div class="cat-page">
            ...
            <div class="cat-page-header">
                ...
                <a href="{{ request('redirect', route('admin.faqs.index')) }}" class="btn-secondary-dash">
                ...
                <div class="cat-card">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="question" class="form-control-dash"
                                value="{{ old('question', $faq->question) }}" required>
                        </div>

                        <div class="form-group">
                            <label>Answer <span class="req">*</span></label>
                            <textarea name="answer" class="form-control-dash" rows="6" required>{{ old('answer', $faq->answer) }}</textarea>
                        </div>

                        <div class="form-row-cols">
                            <div class="form-group">
                                <label>Sort Order</label>
                                <input type="number" name="sort_order" class="form-control-dash"
                    ...
                    <div class="form-footer">
                        <button type="submit" class="btn-primary-dash">
                            <i class="fa fa-check"></i> Update FAQ
                        </button>
                        <a href="{{ request('redirect', route('admin.faqs.index')) }}" class="btn-secondary-dash">Cancel</a>
                    </div>
