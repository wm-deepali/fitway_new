{{-- resources/views/admin/dynamic-pages/create.blade.php --}}
            ...
            <form action="{{ route('admin.dynamic-pages.store') }}" method="POST">
                ...
                <div class="cat-card">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            <label>Slug</label>
                            <input type="text" name="slug" class="form-control-dash" value="{{ old('slug') }}">
                            <div class="hint">Leave blank to auto-generate from the title.</div>
                        </div>

                        <div class="form-group">
                            <label>Content</label>
                            <textarea name="content" id="content" class="form-control-dash" rows="10">{{ old('content') }}</textarea>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_title" class="form-control-dash" value="{{ old('meta_title') }}">
                        </div>

                        <div class="form-group">
                            <label>Meta Keywords</label>
                            <input type="text" name="meta_keywords" class="form-control-dash" value="{{ old('meta_keywords') }}">
                        </div>

                        <div class="form-group">
                            <label>Meta Description</label>
                            <textarea name="meta_description" class="form-control-dash" rows="3">{{ old('meta_description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-footer">
                        ...
                        <a href="{{ route('admin.dynamic-pages.index') }}" class="btn-secondary-dash">Cancel</a>
                    </div>
...
{{-- If Blogs uses CKEditor/TinyMCE/Summernote on its content field, attach it to
     #content here the same way, so this matches your existing editor setup. --}}