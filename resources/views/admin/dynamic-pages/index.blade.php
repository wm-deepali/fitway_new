{{-- resources/views/admin/dynamic-pages/index.blade.php --}}
    ...
    <div class="app-content content container-fluid">
        <div class="cat-page">
            ...
            <div class="cat-page-header">
                ...
                <a href="{{ route('admin.dynamic-pages.create') }}" class="btn-primary-dash">
            ...
            <div class="cat-card">
                    ...
                    <form method="GET">
                        <div class="form-row-inner">
                            ...
                            <div class="filter-actions">
                                ...
                                <a href="{{ route('admin.dynamic-pages.index') }}" class="btn-secondary-dash">
                ...
                <div class="cat-table-wrap">
                    ...
                    @php
                        function dynamicPageSortUrl($column) {
                        ...
                        function dynamicPageSortIcon($column) {
                    ...
                    <table class="cat-table">
                        <thead>
                            <tr>
                                <th>
                                    <a href="{{ dynamicPageSortUrl('id') }}" class="sort-link">ID {!! dynamicPageSortIcon('id') !!}</a>
                                </th>
                                <th>
                                    <a href="{{ dynamicPageSortUrl('title') }}" class="sort-link">Title {!! dynamicPageSortIcon('title') !!}</a>
                                </th>
                                <th>Slug</th>
                                <th>
                                    <a href="{{ dynamicPageSortUrl('status') }}" class="sort-link">Status {!! dynamicPageSortIcon('status') !!}</a>
                                </th>
                                <th>
                                    <a href="{{ dynamicPageSortUrl('created_at') }}" class="sort-link">Created {!! dynamicPageSortIcon('created_at') !!}</a>
                                </th>
                        ...
                        <tbody>
                            @forelse($pages as $item)
                                <tr id="row{{ $item->id }}">
                                    ...
                                    <td style="color:var(--text-secondary);font-size:13px">{{ $item->slug }}</td>
                                    ...
                                    <td>
                                        <div style="display:flex;gap:6px">
                                            <a href="{{ route('admin.dynamic-pages.edit', ['dynamicPage' => $item->id, 'redirect' => request()->fullUrl()]) }}"
                                                class="action-btn" title="Edit">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <button class="action-btn action-btn-danger"
                                                onclick="deleteDynamicPage({{ $item->id }})" title="Delete">
                                ...
                                <tr>
                                    <td colspan="6">
                                        <div class="empty-state">
                                            ...
                                            <p>Try adjusting your search or add a new page to get started.</p>
                                            <a href="{{ route('admin.dynamic-pages.create') }}" class="btn-primary-dash">
                                                <i class="fa fa-plus"></i> Add Page
                                            </a>
                                        </div>
...
function deleteDynamicPage(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ url('admin/dynamic-pages') }}/" + id,
                type: "DELETE",
