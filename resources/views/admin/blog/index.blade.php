                        ...
                        <div class="form-row-inner">
                            ...
                            <div class="filter-group" style="flex:1">
                                ...
                                <input type="text" name="search" value="{{ request('search') }}"
                                    class="filter-control filter-control-wide" placeholder="Search blog title…">
                            </div>
                ...
                <div class="cat-table-wrap">
                    ...
                    <table class="cat-table">
                        <thead>
                            <tr>
                                <th>
                                    <a href="{{ blogSortUrl('id') }}" class="sort-link">ID
                                        {!! blogSortIcon('id') !!}</a>
                                </th>
                                <th>Image</th>
                                <th>
                                    <a href="{{ blogSortUrl('blog') }}" class="sort-link">Title
                                        {!! blogSortIcon('blog') !!}</a>
                                </th>
                                <th>
                                    <a href="{{ blogSortUrl('date_of_blog') }}" class="sort-link">Date
                                        {!! blogSortIcon('date_of_blog') !!}</a>
                                </th>
                                <th>
                                    <a href="{{ blogSortUrl('status') }}" class="sort-link">Status
                                        {!! blogSortIcon('status') !!}</a>
                                </th>
                        ...
                        <tbody>
                            @forelse($blogs as $item)
                                                    <tr id="row{{ $item->id }}">
                                                        ...
                                                        <td>
                                                            @if($item->image)
                                                                <img src="{{ asset('storage/' . $item->image) }}" class="cat-img"
                                                                    alt="{{ $item->blog }}">
                                                            @else
                                                        ...
                                                        <td style="font-weight:600;font-size:13px">
                                                            {{ $item->blog }}
                                                            @if($item->tag)
                                                                <div style="font-weight:400;font-size:11.5px;color:var(--text-hint);margin-top:2px">
                                                                    {{ $item->tag }}</div>
                                                            @endif
                                                        </td>
