...
<div class="main-section">
    ...
    .cat-img { width: 60px; height: 44px; border-radius: var(--radius-sm); object-fit: cover; border: 1px solid var(--border); }
    .cat-img-placeholder { width: 60px; height: 44px; border-radius: var(--radius-sm); background: var(--bg); display: flex; align-items: center; justify-content: center; color: var(--text-hint); font-size: 16px; border: 1px solid var(--border); }
                ...
                <div class="cat-table-wrap">
                    ...
                    <table class="cat-table">
                        <thead>
                            <tr>
                                <th>
                                    <a href="{{ blogSortUrl('id') }}" class="sort-link">ID {!! blogSortIcon('id') !!}</a>
                                </th>
                                <th>Image</th>
                                <th>
                                    <a href="{{ blogSortUrl('blog') }}" class="sort-link">Title {!! blogSortIcon('blog') !!}</a>
                                </th>
                                <th>
                                    <a href="{{ blogSortUrl('date_of_blog') }}" class="sort-link">Date {!! blogSortIcon('date_of_blog') !!}</a>
                                </th>
                                <th>
                                    <a href="{{ blogSortUrl('status') }}" class="sort-link">Status {!! blogSortIcon('status') !!}</a>
                                </th>
                        ...
                        <tbody>
                            @forelse($blogs as $item)
                                <tr id="row{{ $item->id }}">
                                    ...
                                    <td style="font-weight:600;font-size:13px">{{ $item->blog }}</td>

                                    <td style="color:var(--text-secondary);font-size:13px">
                                        {{ optional($item->date_of_blog)->format('d M Y') }}
                                    </td>
