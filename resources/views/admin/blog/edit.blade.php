                ...
                <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="meta_title" name="meta_title"
                            ...
                            value="{{ old('meta_title', $blog->meta_title) }}" placeholder="Defaults to blog title if left blank">
                    ...
                    <div class="form-field">
                        ...
                        <textarea id="meta_description" name="meta_description" rows="3"
                            ...
                            placeholder="Defaults to the short description if left blank">{{ old('meta_description', $blog->meta_description) }}</textarea>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="h1" name="h1"
                            ...
                            value="{{ old('h1', $blog->h1) }}" placeholder="Auto-filled from Blog Title">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="og_title" name="og_title"
                            ...
                            value="{{ old('og_title', $blog->og_title) }}" placeholder="Auto-filled from Meta Title">
                    ...
                    <div class="form-field">
                        ...
                        <textarea id="og_description" name="og_description" rows="3"
                            ...
                            placeholder="Auto-filled from Meta Description">{{ old('og_description', $blog->og_description) }}</textarea>
                    ...
                    <div class="form-field">
                        ...
                        @if($blog->og_image)
                            <img src="{{ asset('storage/' . $blog->og_image) }}" class="current-img-preview" alt="OG image">
                        @endif
                        <input type="file" id="og_image" name="og_image"
                            class="form-control-styled @error('og_image') is-invalid @enderror" accept="image/*">
                        <div class="hint">Leave blank to keep current — falls back to the main blog image if never set</div>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="canonical_url" name="canonical_url"
                            ...
                            value="{{ old('canonical_url', $blog->canonical_url) }}" placeholder="Auto-generated from slug">
...
<script>
    ...
    // SEO auto-fill — treat fields that already have a saved value as "edited" so typing
    // in the blog title doesn't silently overwrite an admin's existing override.
    let h1Edited = document.getElementById('h1').value.trim().length > 0;
    let ogTitleEdited = document.getElementById('og_title').value.trim().length > 0;
    let ogDescEdited = document.getElementById('og_description').value.trim().length > 0;
    let canonicalEdited = document.getElementById('canonical_url').value.trim().length > 0;
