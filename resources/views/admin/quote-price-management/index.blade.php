            ...
            <div class="page-header">
                <div>
                    ...
                    <div class="crumb">
                        ...
                        <span>›</span>
                        <a href="{{ route('admin.quotes.index') }}">Quotation System</a>
                        <span>›</span>
                        Price Management
                    </div>
                </div>
            ...
            <div class="kpi-strip">
                <div class="kpi-tile">
                    ...
                    <div>
                        ...
                        <div class="kpi-sub">Internal Inventory</div>
                    </div>
                </div>
                <div class="kpi-tile">
            ...
            <div class="stock-card">
                ...
                <form method="GET" action="{{ route('admin.quote-price-management.index') }}" class="filter-bar" id="filters-form">
                    <div class="filter-row">
                        ...
                        <div class="filter-group">
                            <label>Brand</label>
                            <select name="brand_id" class="filter-control">
                        ...
                        <div style="display:flex;gap:8px;align-items:flex-end">
                            ...
                            <a href="{{ route('admin.quote-price-management.index') }}" class="btn-filter-reset"><i
...
<script>
    const PRICE_UPDATE_URL_TEMPLATE = "{{ route('admin.quote-price-management.update', ['product' => '__ID__']) }}";
    ...
    // ---------- Logs modal ----------
    const LOGS_URL_TEMPLATE = "{{ route('admin.quote-price-management.logs', ['product' => '__ID__']) }}";
