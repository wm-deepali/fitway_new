                ...
                <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="h1" name="h1"
                            ...
                            value="{{ old('h1', $category->h1) }}" placeholder="Auto-filled from Category Name">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="og_title" name="og_title"
                            ...
                            value="{{ old('og_title', $category->og_title) }}" placeholder="Auto-filled from Meta Title">
                    ...
                    <div class="form-field">
                        ...
                        <textarea id="og_description" name="og_description" rows="3"
                            ...
                            placeholder="Auto-filled from Meta Description">{{ old('og_description', $category->og_description) }}</textarea>
                    ...
                    <div class="form-field">
                        ...
                        @if($category->og_image)
                            <img src="{{ asset('storage/' . $category->og_image) }}" class="current-img-preview" alt="OG image">
                        @elseif($category->image)
                            <img src="{{ asset('storage/' . $category->image) }}" class="current-img-preview" alt="OG image (using category image)">
                        @endif
                        <input type="file" id="og_image" name="og_image"
                            class="form-control-styled @error('og_image') is-invalid @enderror" accept="image/*">
                        <div class="hint">Leave blank to keep current / automatically use the Category Image as OG Image</div>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="canonical_url" name="canonical_url"
                            ...
                            value="{{ old('canonical_url', $category->canonical_url) }}" placeholder="Auto-generated from slug">
