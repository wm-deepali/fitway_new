                ...
                <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="slug" name="slug" class="form-control-styled" readonly
                            value="{{ old('slug') }}" placeholder="Auto-generated from category name">
                    ...
                    <div class="form-field toggle-row">
                        <label class="switch">
                            <input type="checkbox" name="premium" value="premium" {{ old('premium') ? 'checked' : '' }}>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="h1" name="h1"
                            ...
                            value="{{ old('h1') }}" placeholder="Auto-filled from Category Name">
