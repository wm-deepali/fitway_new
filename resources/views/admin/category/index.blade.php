...
<div class="main-section">
    ...
    .cat-page-header h1 { font-size: 20px; font-weight: 650; color: var(--text-primary); margin: 0; }
    ...
    .cat-table tbody tr { border-bottom: 1px solid var(--border); transition: background .1s; }
    .cat-table tbody tr:last-child { border-bottom: none; }
    .cat-table tbody tr:hover { background: #fafbfc; }
    .cat-table tbody td { padding: 12px 16px; color: var(--text-primary); vertical-align: middle; }
    ...
    .cat-name-cell strong { display: block; font-weight: 600; color: var(--text-primary); font-size: 13px; }
                        ...
                        <tbody>
                            @forelse($categories as $cat)
                                <tr id="row{{ $cat->id }}">
                                    ...
                                    <td>
                                        {!! $cat->premium === 'premium'
                                            ? '<span class="pill pill-yes">Premium</span>'
                                            : '<span class="pill pill-no">Normal</span>' !!}
                                    </td>
