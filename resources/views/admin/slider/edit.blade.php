...
<div class="main-section">
    ...
    .current-img-preview { width: 180px; height: 90px; border-radius: var(--radius-sm); object-fit: cover; border: 1px solid var(--border); margin-bottom: 10px; display: block; }
    </style>
    ...
    <div class="app-content content container-fluid">
        <div class="cat-page">
            ...
            <div class="cat-page-header">
                ...
                <a href="{{ request('redirect', route('admin.sliders.index')) }}" class="btn-secondary-dash">
            ...
            <div class="cat-card">
                <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-field">
                        ...
                        @if($slider->slider)
                            <img src="{{ asset('storage/' . $slider->slider) }}" class="current-img-preview" alt="{{ $slider->title }}">
                        @endif
                        <input type="file" id="slider" name="slider"
                            class="form-control-styled @error('slider') is-invalid @enderror">
                        <div class="hint">Leave blank to keep the current image — JPG, PNG, GIF, WEBP or SVG, max 2MB</div>
                        @error('slider') <div class="form-error">{{ $message }}</div> @enderror
                    </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-primary-dash">
                            <i class="fa fa-check"></i> Update Slider
                        </button>
                        <a href="{{ request('redirect', route('admin.sliders.index')) }}" class="btn-secondary-dash">Cancel</a>
                    </div>
