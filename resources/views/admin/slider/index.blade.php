...
<div class="main-section">
    ...
    .slide-img { width: 90px; height: 44px; border-radius: var(--radius-sm); object-fit: cover; border: 1px solid var(--border); }
    .slide-img-placeholder { width: 90px; height: 44px; border-radius: var(--radius-sm); background: var(--bg); display: flex; align-items: center; justify-content: center; color: var(--text-hint); font-size: 16px; border: 1px solid var(--border); }
                    ...
                    <form method="GET">
                        <div class="form-row-inner">
                            ...
                            <div class="filter-actions">
                                ...
                                <a href="{{ route('admin.sliders.index') }}" class="btn-secondary-dash">
                ...
                <div class="cat-table-wrap">
                    ...
                    <table class="cat-table">
                        <thead>
                            <tr>
                                <th>
                                    <a href="{{ sliderSortUrl('id') }}" class="sort-link">ID {!! sliderSortIcon('id') !!}</a>
                                </th>
                                <th>Image</th>
                                <th>
                                    <a href="{{ sliderSortUrl('title') }}" class="sort-link">Title {!! sliderSortIcon('title') !!}</a>
                                </th>
                                <th>
                                    <a href="{{ sliderSortUrl('sort_order') }}" class="sort-link">Sort {!! sliderSortIcon('sort_order') !!}</a>
                                </th>
                                <th>
                                    <a href="{{ sliderSortUrl('status') }}" class="sort-link">Status {!! sliderSortIcon('status') !!}</a>
                                </th>
                        ...
                        <tbody>
                            @forelse($sliders as $item)
                                <tr id="row{{ $item->id }}">
                                    ...
                                    <td>
                                        @if($item->slider)
                                            <img src="{{ asset('storage/' . $item->slider) }}"
                                                class="slide-img" alt="{{ $item->title }}">
                                        @else
                                    ...
                                    <td style="font-weight:600;font-size:13px">{{ $item->title }}</td>
